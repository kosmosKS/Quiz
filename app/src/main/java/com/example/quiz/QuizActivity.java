...
public class QuizActivity extends AppCompatActivity {
    ...
    private void showSolution() {
        ...
        switch (currentQuestion.getAnswerNr()) {
            case 1:
                ...
                textViewQuestion.setText("Первый вопрос верный");
                break;
            case 2:
                rb2.setTextColor(Color.GREEN);
                textViewQuestion.setText("Второй вопрос верный");
                break;
            case 3:
                rb3.setTextColor(Color.GREEN);
                textViewQuestion.setText("Третий вопрос верный");
                break;
        }

        if (questionCounter < questionCountTotal) {
            buttonConfirmNext.setText("Следущий");
        } else {
    ...
    public void onBackPressed() {
        if (backPressedTime + 2000 > System.currentTimeMillis()) {
            ...
            Toast.makeText(this, "Нажать назад снова чтобы закончить", Toast.LENGTH_SHORT).show();
        }
